    ...
    <div class="row justify-content-center">
        <div class="col">
            ...
            <div class="col card p-5 text-center">
                ...
                <p class="text-secondary">Queres mesmo apagar esta nota?</p>
                <div class="mt-3">
                    <a href="{{ route('home') }}" class="btn btn-primary px-5 m-2"><i class="fa-solid fa-xmark me-2"></i>No</a>
                    <a href="{{ route('deleteSubmit', ['id' => Crypt::encrypt($note->id)]) }}" class="btn btn-danger px-5 m-2"><i class="fa-solid fa-trash me-2"></i>Yes</a>
                </div>
            </div>
        </div>
    </div>
